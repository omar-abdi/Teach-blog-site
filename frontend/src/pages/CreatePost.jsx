...
<input type="text"  placeholder='Enter Title Your post' className='w-full rounded-lg px-4 py-2 text-slate-700 border border-slate-300' />
    </div>
    <div className='space-y-2' >
      {/* category input */}
<label  className='block text-sm font-medium text-gray-800' htmlFor='category'>Categroy:</label>
<input type="text"  placeholder='Category post' className='w-full rounded-lg px-4 py-2 text-slate-700 border border-slate-300' />
    </div>
    <div className='space-y-2' >
      {/* image input */}
...
<ReactQuill placeholder='Your post Content' className='mb-12'/>
    </div>
    <button className='w-full md:w-1/2 bg-gray-700 shadow-lg rounded-lg px-6 py-3 text-white hover:bg-gray-900'>Post </button>
  </form>
    </div>
  )
}
